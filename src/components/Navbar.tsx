...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#05112F] backdrop-blur-sm border-b border-gray-200 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="md:hidden">
            <Button
              ...
              className="p-2 text-white hover:text-teal hover:bg-[#05112F]/80"
            >
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-[#05112F] border-t border-gray-600">
              {navLinks.map((link) => (
                <Link
                  key={link.path}
                  to={link.path}
                  ...
                  className={`block px-3 py-2 text-base font-medium transition-colors ${
                    isActive(link.path) ? 'text-teal bg-[#05112F]/50' : 'text-gray-300 hover:text-teal'
                  }`}
                >
                  {link.label}
                </Link>
